...
type PositionServiceClient interface {
	...
	Delete(ctx context.Context, in *PositionPrimaryKey, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *positionServiceClient) Delete(ctx context.Context, in *PositionPrimaryKey, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
type PositionServiceServer interface {
	...
	Delete(context.Context, *PositionPrimaryKey) (*emptypb.Empty, error)
...
func (UnimplementedPositionServiceServer) Delete(context.Context, *PositionPrimaryKey) (*emptypb.Empty, error) {
